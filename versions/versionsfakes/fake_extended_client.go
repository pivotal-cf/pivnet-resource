...
func (fake *FakeExtendedClient) ReleaseFingerprint(productSlug string, releaseID int) (string, error) {
...
func (fake *FakeExtendedClient) ReleaseFingerprintCallCount() int {
...
func (fake *FakeExtendedClient) ReleaseFingerprintArgsForCall(i int) (string, int) {
	fake.releaseFingerprintMutex.RLock()
	defer fake.releaseFingerprintMutex.RUnlock()
	return fake.releaseFingerprintArgsForCall[i].productSlug, fake.releaseFingerprintArgsForCall[i].releaseID
}

func (fake *FakeExtendedClient) ReleaseFingerprintReturns(result1 string, result2 error) {
